...
model.add(LSTM(32, batch_input_shape=(batch_size, sample_size, 56), dropout=0.1, recurrent_dropout=0.5, return_sequences=True, stateful=True))
model.add(LSTM(64, dropout=0.1, recurrent_dropout=0.5, stateful=True))
